...
# Data folder
__C.PATH.DATA = osp.abspath(('/Your_path/DAVIS'))
...
__C.PATH.ANNOTATIONS_CTR = osp.join(__C.PATH.DATA, "Annotations_ctr", __C.RESOLUTION)

__C.PATH.FLOW = osp.join(__C.PATH.DATA, 'davis-flow/')
